...
public class UtilityMethods {
     ...
     * @return A valid timestamp for that string
     */
    ...
    /**
     * This is a utlity method that will transform a timestamp into a string in the format {@value Constants#AVERAGE_REQUEST_DATE_FORMAT}
     *
     * @param input A specific timestamp
     * @return A formated string for that timestamp
     */
